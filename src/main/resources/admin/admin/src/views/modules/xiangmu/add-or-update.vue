               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="科研项目名称" prop="xiangmuName">
                       <el-input v-model="ruleForm.xiangmuName"
                                 placeholder="科研项目名称" clearable  :readonly="ro.xiangmuName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="科研项目类型" prop="xiangmuTypes">
                        <el-select v-model="ruleForm.xiangmuTypes" :disabled="ro.xiangmuTypes" placeholder="请选择科研项目类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiangmuFile" label="相关文件" prop="xiangmuFile">
                        <file-upload
                                tip="点击上传相关文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.xiangmuFile?ruleForm.xiangmuFile:''"
                                @change="xiangmuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuFile" label="相关文件" prop="xiangmuFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.xiangmuFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="科研项目介绍" prop="xiangmuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuContent" label="科研项目介绍" prop="xiangmuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiangmuTypes: [
                              { required: true, message: '科研项目类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   xiangmuContent: [
                              { required: true, message: '科研项目介绍不能为空', trigger: 'blur' },
                          ],
                   xiangmuDelete: [
