<template>
    <div style="backgroundImage: url('/keyangongzuoliang/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">科研工作量管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="秘书姓名" class="input" v-if="tableName=='mishu'">
                            <el-input v-model="ruleForm.mishuName" autocomplete="off" placeholder="秘书姓名"  />
                        </el-form-item>
                        <el-form-item label="秘书手机号" class="input" v-if="tableName=='mishu'">
                            <el-input v-model="ruleForm.mishuPhone" autocomplete="off" placeholder="秘书手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='mishu'">
                            <el-input v-model="ruleForm.mishuEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.mishuName)&& 'mishu'==this.tableName){
                                this.$message.error('秘书姓名不能为空');
                                return
                            }
                             if('mishu' == this.tableName && this.ruleForm.mishuPhone&&(!this.$validate.isMobile(this.ruleForm.mishuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('mishu' == this.tableName && this.ruleForm.mishuEmail&&(!this.$validate.isEmail(this.ruleForm.mishuEmail))){
